...
# from control_drive import get_list_obj, clear_disk
...
# Функция, в которой выдаются права доступа личному гугл-аккаунту
...
# В этой фукции создаётся документ с таблицами
